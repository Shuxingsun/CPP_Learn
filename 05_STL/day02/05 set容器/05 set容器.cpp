...
void test02()
{
	...
	//对于set 集合而言，count的结果 要么是0要么是1

	int num = s.count(40);

	cout << "key为40的个数 ：" << num << endl;
...
//第五个测试有问题 解决了const  bool operator()(int v1, int v2) const
void test05()
{
	//set容器的排序规则要在插入之前指定
